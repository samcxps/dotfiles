...
return require('packer').startup({
  function(use)
    ...
    use { 'lewis6991/impatient.nvim' }      -- Speeds up loading of plugins
    use { 'nathom/filetype.nvim' }          -- Faster version of filetype.vim 
    use { 'nvim-lua/plenary.nvim' }         -- Requisite for telescope.nvim
    use { 'kyazdani42/nvim-web-devicons' }  -- Icons for web dev stuff
    use { 'glepnir/dashboard-nvim',         -- Provides cool dashboard/gui for vim on load
    ...
    use { 'vuki656/package-info.nvim', disable = not GigaVim.plugins.package_info.enabled }
    ...
    use {
     ...
     use {
        ...
        run = 'yarn install',
        ft = {'javascript', 'typescript', 'typescriptreact', 'javascriptreact', 'css', 'less', 'scss', 'graphql', 'markdown', 'vue', 'html'}
      }

    -- Nvim Tree / Rooter
    use { 'kyazdani42/nvim-tree.lua', config = "require('plugins.tree')" }
    use { 'airblade/vim-rooter', setup = function() vim.g.rooter_patterns = GigaVim.plugins.rooter.patterns end }
